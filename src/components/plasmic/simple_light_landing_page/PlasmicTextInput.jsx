...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: nhlNKPJYgoD42t/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: ch-aGeMdRoS56g/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___67Vx5)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__swUpl)}
                role={"img"}
              />
            ),
